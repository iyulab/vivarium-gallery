...
동반 변경은 저작자가 한 문서에 담아야 한다. 파괴성 축이 그 대가를 날카롭게 만든다는
[입장 문서](../../../../../claudedocs/plans/2026-08-04-destructive-change-stance.md) §3 의
문장이, 여기서 **실모델·실화면으로** 확인됐다: 더하는 축에서 비정합은 "빈 칸"이지만
개명에서는 **보이던 것이 사라진다**.
